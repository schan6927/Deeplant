...
trainpath = '../ai-hub-data/Training/'
valpath = '../ai-hub-data/Validation/'
...
train_label_set = pd.read_csv("../ai-hub-data/train.csv")
val_label_set = pd.read_csv("../ai-hub-data/valid.csv")
...
valid_dataloader = DataLoader(valid_dataset, batch_size=batch_size, shuffle=True, num_workers=8, pin_memory=True)
